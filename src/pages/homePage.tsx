...
const HomePage: React.FC = () => {
  ...
  if (loading) {return <Flex justify='center' align='center' height='100vh'>Loading...</Flex>}
  if (error) {return <Flex justify='center' align='center' height='100vh'>Error: {error}</Flex>}
